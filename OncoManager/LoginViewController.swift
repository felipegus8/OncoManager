...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let someDateTime = formatter.dateFromString("2016/06/23 17:00")
        let testeExame =  Exame(cpf:16798089766,codigo: 8, nome: "TesteExame", medico: "Testando", local: "Copa", data:someDateTime!, aprovado: 0, realizado: 1)
